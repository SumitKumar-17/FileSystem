...
MainWindowFileOps::MainWindowFileOps(MainWindow *mainWindow) : mainWindow(mainWindow) {
}

void MainWindowFileOps::createFile() {
    bool ok;
    QString fileName = QInputDialog::getText(
        mainWindow, "Create File", "Enter file name:", QLineEdit::Normal, "new_file.txt", &ok);
...
void MainWindowFileOps::createDirectory() {
    bool ok;
    QString dirName =
        QInputDialog::getText(mainWindow, "Create Directory",
                              "Enter directory name:", QLineEdit::Normal, "new_directory", &ok);
...
void MainWindowFileOps::fileContextMenu(const QPoint &pos) {
    ...
    if (selectedAction == openAction) {
        ...
        bool ok;
        QString newName =
            QInputDialog::getText(mainWindow, "Rename", "Enter new name:", QLineEdit::Normal,
                                  QString::fromStdString(file_name), &ok);
