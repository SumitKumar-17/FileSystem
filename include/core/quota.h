...
public:
    ...
    // Set quotas
    void set_user_quota(int uid, int blocks_soft, int blocks_hard, int inodes_soft, int inodes_hard);
    void set_group_quota(int gid, int blocks_soft, int blocks_hard, int inodes_soft, int inodes_hard);
